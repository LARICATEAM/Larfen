...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/Larfen/main/Larfen.lua')
...
-------------
if text == "꙳. تحديثات سورس لارفين ꙳." and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس لارفين*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙚𝘼𝙢 𝙡𝙖𝙧𝙛𝙚𝙣', url="t.me/GGIIGGG"}},
}
...
Text = "𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙡𝙖𝙧𝙛𝙚𝙣\n\n[𝙏𝙚𝘼𝙢 𝙡𝙖𝙧𝙛𝙚𝙣 ](http://t.me/GGIIGGG)\n\n[𝙐𝙥𝙙𝙖𝙩𝙚𝙨 𝙡𝙖𝙧𝙛𝙚𝙣 ](http://t.me/GGIIGGG)\n\n[𝙏𝙬𝙎 𝙎𝙤𝙪𝙧𝙘𝙚 ](http://t.me/g_ngbot)"
keyboard = {} 
keyboard.inline_keyboard = {
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Larfen-TEAM/Files_Larfen/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Larfen-TEAM/Files_Larfen/main/File_Bot/"..file)
if res == 200 then
...
end --الكود حصري سورس لارفين يعني لو بكتهن راح اعرفك انت الاخذتهن
